function [nframes,matrix,res,timeres,VENC,area_vol,diam_vol,flowPerHeartCycle_vol, ...
    ...
    bnumMeanFlow,bnumStdvFlow,StdvFromMean,SEGcrossection] = loadpcvipr(directory,handles)
...
[area_vol,diam_vol,flowPerHeartCycle_vol,maxVel_vol,PI_vol,RI_vol, ...
    ...
    area_valK,diam_valK,flowPerHeartCycle_valK,maxVel_valK,PI_valK,RI_valK,flowPulsatile_valK,...
    velMean_valK,segmentFullK,bnumMeanFlowK,bnumStdvFlowK,StdvFromMeanK,SEGcrossection] ...
